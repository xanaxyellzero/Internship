            ...
            <div class="justify-center row">
                <div class="w-full lg:w-2/3">
                    <div class="pb-10 text-center section-title">
                        ...
                        <h3 class="title">Prediktif, Responsibilitas, Transparansi Berkeadilan<span> kami ada untuk mengayomi masyarakat</span></h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="justify-center row ">
                ...
                <div class="w-full sm:w-2/3 lg:w-1/3 ">
                    <div class="mt-8 text-center single-services wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="services-icon">
                            <img class="shape" src="/image/{{ $card->image }}" style="border-radius: 3%;" alt="shape">
                        </div>
        ...
        <div class="row">
          ...
          <div class="w-full lg:w-1/2">
            <div
              ...
              data-wow-delay="0.5s"
            >
              <img src="/image/{{ $about->image  }}" style="border-radius: 20%;" alt="about" />
            </div>
            <!-- about image -->
          </div>
        </div>
                ...
                <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/2">
                  ...
                  >
                    ...
                    <ul class="link">
                      ...
                      <li><a href="portfolio">Official</a></li>
