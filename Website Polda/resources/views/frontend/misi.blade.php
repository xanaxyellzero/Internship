...
@section('title','Portfolio')
  ...
  <section id="team" class="team-area pt-120" style="background-image: url(images/background.png)">
    <div class="container">
        ...
        <div class="mt-10">
          <div class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            <div class="relative">
              ...
              <dd class="mt-2 ml-16 text-base text-gray-500" style="text-align: justify;">
                {{ $misi->visi }}
              </dd>
            </div>
